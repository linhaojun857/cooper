#ifndef util_MsgBuffer_hpp
#define util_MsgBuffer_hpp
...
public:
    ...
    /**
     * @brief Get and remove some bytes from the buffer until a certain position
     * @param end
     * @return
     */
...
namespace std {
template <>
inline void swap(cooper::MsgBuffer& one, cooper::MsgBuffer& two) noexcept {
    one.swap(two);
}
}  // namespace std
